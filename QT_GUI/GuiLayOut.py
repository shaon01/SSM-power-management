...
class Ui_GuiLayOut(object):
    def setupUi(self, GuiLayOut):
        GuiLayOut.setObjectName("GuiLayOut")
        GuiLayOut.resize(640, 480)
        GuiLayOut.setAutoFillBackground(False)
        self.buttonBox = QtWidgets.QDialogButtonBox(GuiLayOut)
        self.buttonBox.setGeometry(QtCore.QRect(10, 440, 621, 32))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Cancel|QtWidgets.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.ControlGroup = QtWidgets.QGroupBox(GuiLayOut)
        self.ControlGroup.setGeometry(QtCore.QRect(40, 40, 251, 191))
        font = QtGui.QFont()
...
"alternate-background-color: rgb(0, 170, 0);")
        ...
        self.groupBox = QtWidgets.QGroupBox(GuiLayOut)
        self.groupBox.setGeometry(QtCore.QRect(40, 300, 371, 81))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.retranslateUi(GuiLayOut)
        self.buttonBox.accepted.connect(GuiLayOut.accept)
        self.buttonBox.rejected.connect(GuiLayOut.reject)
        QtCore.QMetaObject.connectSlotsByName(GuiLayOut)

    def retranslateUi(self, GuiLayOut):
        _translate = QtCore.QCoreApplication.translate
        GuiLayOut.setWindowTitle(_translate("GuiLayOut", "Dialog"))
        self.ControlGroup.setTitle(_translate("GuiLayOut", "Control"))
        self.btn_Power.setText(_translate("GuiLayOut", "All Power"))
        self.lbl_SSM_A.setText(_translate("GuiLayOut", "OFF"))
        self.lbl_kl15.setText(_translate("GuiLayOut", "OFF"))
        self.btn_kl15.setText(_translate("GuiLayOut", "KL 15"))
        self.btn_SSM_A.setText(_translate("GuiLayOut", "SSM_A"))
        self.btn_SSM_B.setText(_translate("GuiLayOut", "SSM_B"))
        self.lbl_SSM_B.setText(_translate("GuiLayOut", "OFF"))
        self.lbl_Power.setText(_translate("GuiLayOut", "OFF"))
        self.groupBox.setTitle(_translate("GuiLayOut", "Connection Status"))
        self.btn_connect.setText(_translate("GuiLayOut", "Reconnect"))
